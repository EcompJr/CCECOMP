...
<body>
    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col-lg-12">
                <h1 class="page-header">Estágio
                </h1>
                <ol class="breadcrumb">
                    <li><a href="index.php">Home</a>
                    </li>
                    <li class="active">Estágio</li>
                </ol>
            </div>
        </div>
        <!-- /.row -->
        ...
        <div class="row">
            <div class="col-lg-12">
                ...
                <b>b)</b> Seguro contra acidentes pessoais contratado pela empresa em favor do estagiário, cujo número da apólice deve constar no termo de compromisso;</br>
                <b>c)</b> A jornada semanal seja de, no máximo, 40 horas e, no mínimo, 32 horas, para os componentes curriculares TEC 427 e EXA 827 (Estágio em Tempo Integral);</br>
                <b>d)</b> A jornada semanal seja de, no máximo, 30 horas e, no mínimo, 20 horas, para os componentes curriculares TEC 428 e EXA 828 (Estágio); </br>
                ...
                <b>b)</b> Plano de Trabalho assinado pelo supervisor da empresa;</br>
                <b>c)</b> Formulário de Solicitação de Estágio Curricular; (veja abaixo)</br>
                <b>d)</b> Comprovação pelo Supervisor da empresa de "formação ou experiência profissional na área de conhecimento desenvolvida no curso do estagiário" (diploma graduação ou pós-graduação, declaração de experiência assinada pela empresa, currículo assinado pelo supervisor, etc)</br></br>

                Ao final do semestre do estágio obrigatório, deve ser entregue relatório final e ficha de avaliação do supervisor.</br>
                ...
                <b>Textuais: </b>objetivos; atividades a serem desenvolvidas; metodologia; cronograma; ambiente de trabalho (descrição da empresa e das condições de trabalho); <br>
                <b>Pós-textuais: </b>referências bibliográficas, quando necessário; anexos (quando for o caso); assinatura do Supervisor.<br><br>

                Recomenda-se a seguinte formatação: <br>
                <br>
                Papel tamanho A4; <br>
                Espaço simples entre linhas e de 0,5 linha entre parágrafos; <br>
                Fonte <i>times</i> 12 (texto); <br>
                Margens: superior 2,5cm / inferior 2,5cm / esquerda 2,5cm / direita 2,5cm / numeração de página no fim de página.
                Não use quebra de página entre as seções textuais.<br><br>

                <b>IMPORTANTE: </b> Descrevam o que vocês realmente poderão ou irão fizer, essa é a parte mais importante. Podem até descrever outras atividades que são realizadas pela equipe na qual trabalharam para contextualizar, mas o mais importante são SUAS atividades. Não precisam estar alocados em um projeto específico, basta deixar claro as atividades que serão/poderão ser de sua reaposabilidade. Podem usar a primeira pessoa do singular (EU) para detalhar suas atividades.<br><br>
